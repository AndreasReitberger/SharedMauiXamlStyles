...
{
    public partial class SyncfusionToolkitPageViewModel : BaseViewModel
    {
        ...
        public SyncfusionToolkitPageViewModel(IDispatcher dispatcher, IServiceProvider provider) : base(dispatcher, provider)
        {
