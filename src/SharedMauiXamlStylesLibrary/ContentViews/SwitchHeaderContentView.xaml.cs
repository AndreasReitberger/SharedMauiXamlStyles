...
public partial class SwitchHeaderContentView : ContentView
{
    ...
    public static readonly BindableProperty ButtonIconFontFamilyProperty = BindableProperty.Create(nameof(ButtonIconFontFamily), typeof(string), typeof(SwitchHeaderContentView), MaterialDesignIconsOutlinedRegular.FontFamily);
    ...
    public static readonly BindableProperty BackButtonIconTextProperty = BindableProperty.Create(nameof(BackButtonIconText), typeof(string), typeof(SwitchHeaderContentView), MaterialDesignIconsOutlinedRegular.Filter);
    public static readonly BindableProperty NextButtonIconTextProperty = BindableProperty.Create(nameof(NextButtonIconText), typeof(string), typeof(SwitchHeaderContentView), MaterialDesignIconsOutlinedRegular.Sort);
