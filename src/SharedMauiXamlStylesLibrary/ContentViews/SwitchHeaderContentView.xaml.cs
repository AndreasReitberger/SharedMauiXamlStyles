...
public partial class SwitchHeaderContentView : ContentView
{
    ...
    public static readonly BindableProperty ButtonIconFontFamilyProperty = BindableProperty.Create(nameof(ButtonIconFontFamily), typeof(string), typeof(SwitchHeaderContentView), MaterialIcons.FontFamily);
    ...
    public static readonly BindableProperty BackButtonIconTextProperty = BindableProperty.Create(nameof(BackButtonIconText), typeof(string), typeof(SwitchHeaderContentView), MaterialDesignIcons.Filter);
    public static readonly BindableProperty NextButtonIconTextProperty = BindableProperty.Create(nameof(NextButtonIconText), typeof(string), typeof(SwitchHeaderContentView), MaterialDesignIcons.Sort);
